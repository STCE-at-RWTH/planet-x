...
let Minf=4.0
	...
	xlabel!(p, L"\bar{x}")
	ylabel!(p, L"\bar{y}")
	plot!(p, -1:0.001:1, x->x < 0 ? sqrt(1-x^2) : 1.0, type=:shape, fill=true, color=:black, label=false)
	for a = 0.:0.2:4
...
manifest_format = "2.0"
project_hash = "350786572ae65cdc68f0db7c607ae66fdf0b0aac"
